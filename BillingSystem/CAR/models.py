...
class RTO(models.Model):
    ...
    RTO_ENG_NO        = models.CharField(max_length= 20,unique=True,null=True)
    RTO_CHESSISE_NO  = models.CharField(max_length= 20,unique=True,null=True)
    RTO_KEY_NO       = models.CharField(max_length= 20,unique=True,null=True)
